...
Here's an example of using the [ScatterplotOverlay](https://github.com/uber/react-map-gl/tree/5.1-release/examples/additional-overlays/src/scatterplot-overlay.js):
...
There are more examples in the [examples/additional-overlays](https://github.com/uber/react-map-gl/tree/5.1-release/examples/additional-overlays) folder of this repo.
