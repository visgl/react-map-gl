...
* `create-react-app` - react-map-gl is compatible with create-react-app and Typescript. You can see an example [here](https://github.com/zackhsi/react-map-gl-typescript).
