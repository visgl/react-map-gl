...
- **New Components**: [`Layer`](/#/Documentation/api-reference/layer), [`Source`](/#/Documentation/api-reference/source), [`FlyToInterpolator`](/#/Documentation/api-reference/fly-to-interpolator) have been added to provide better React parity with the `Mapbox GL JS` API.
